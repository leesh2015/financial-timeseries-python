"""
Dynamic Time Series Simulation with VECM-EGARCH Hybrid Model

This script implements a dynamic trading simulation using VECM (Vector Error Correction Model)
and EGARCH (Exponential GARCH) hybrid approach with long/short position management.
...
def main():
    ...
    for t in range(len(test_data)):
        ...
        if hybrid_yhat > actual_price and capital > 0 and lower_price < lower_mean:
            if position == 'short':
                ...
                # capital += profit + shares_to_sell * actual_price
                ...
                capital += profit + shares_to_sell * execution_price
                total_shares = 0
                average_price = 0
                position = None
            ...
            #     capital -= shares_to_buy * lower_price
            ...
            if shares_to_buy * execution_price <= capital:
                ...
                total_shares += shares_to_buy
                average_price = total_value / total_shares
                capital -= shares_to_buy * execution_price
        ...
        # Set new SHORT position
            ...
            if position == 'long':
                ...
                # capital += profit + shares_to_sell * upper_price
            ...
            #     capital -= shares_to_sell * upper_price
            ...
            if shares_to_sell * execution_price <= capital:
                ...
                total_shares += shares_to_sell
                average_price = total_value / abs(total_shares)
                capital -= shares_to_sell * execution_price
    ...
    plt.title('Dynamic Time Series Simulation - Capital Over Time', 
    ...
    script_dir = os.path.dirname(os.path.abspath(__file__))
    plot_file = os.path.join(script_dir, 'simulation_results.png')
